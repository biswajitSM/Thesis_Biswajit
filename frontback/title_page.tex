...
\vfill
\begin{center}
    \includegraphics[height=0.5in]{frontback/logos/leiden}
    \hspace{2em}
    \includegraphics[height=0.5in]{frontback/logos/casimir} \\
    \includegraphics[height=0.5in]{frontback/logos/fom}
%    \hspace{2em}
