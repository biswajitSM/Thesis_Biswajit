\chapter{Enhanced fluorescence correlation spectroscopy by a gold nanorod in lipid bilayers}
\label{chapter:EFCS}
...
Confinement of light in volumes much smaller than the diffraction-limited volume combined with fluorescence enhancement enables applications of FCS at micromolar dye concentrations.
...
Then they were rinsed in milliQ water several times and incubated in a \ce{H2O}/\ce{NH4OH}/\ce{H2O2} (5:1:1) bath at \SI{70}{\celsius} after which they were rinsed several times with water and ethanol, and finally stored in ethanol.
...
\input{chapters/c2_bilayer_efcs/si_efcs}
